...
export const program: Record<string, Talk[]> = {
  ...
  "Day 3": [
    ...
    {
      time: "",
      title: "⚡ Lightning Talks (16:00–18:15)",
      date: "May 29, 2025",
      description: "",
      speakerIds: [],
      isBreak: true,
    ...
    {
      time: "16:00",
      title: "Secrets from the ALife Institute",
      date: "May 29, 2025",
      description: "",
      speakerIds: [],
      presenter: "Bert Chan",
    ...
    },
    {
      ...
      description: "",
      speakerIds: [],
      presenter: "Fernando Rosas",
      isBreak: false,
    },
    {
      time: "16:30",
      title: "From Petri Dish to Planet: Scaling Artificial Life",
      date: "May 29, 2025",
      description: "",
      speakerIds: [],
      presenter: "Marko Cvjetko",
      isBreak: false,
    },
    {
      time: "16:45",
      title: "Emergence Without Propagation in BFF",
      date: "May 29, 2025",
      description: "",
      speakerIds: [],
      presenter: "František Dušek",
      isBreak: false,
    },
    {
      time: "17:00",
      ...
      description: "",
      speakerIds: [],
      presenter: "Pedro Márquez-Zacarías",
      isBreak: false,
    },
    {
      time: "17:15",
      title: "Self-organizing adventures in frequency domain",
      date: "May 29, 2025",
      description: "",
      speakerIds: [],
